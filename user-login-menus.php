...
<section class="top-header animated">
	<div class="container">
       ...
       <ul>
        ...
        <div class="row">
            <div class="col-md-5 nopad-right"><img src="silverhat_games/game_home_image/dothedive.png" alt="AAAA" title="AAAA"></div>
      ...
      {  
       ...
       ?>
		...
		<p>Your Total Points</p>
                ...
                ?>
                    <a href="game-point-leader-board">                
