...
<script>
   ...
   function score_pagination(nooflist,messagestatus)
   {
			...
			xhr.open('GET','weekly_pagination.php?noofitemshow='+nooflist+'&message='+messagestatus,true);
			xhr.send();
...
<div class="container">
    ...
    <a href="game-point-leader-board">Point Leaderboard</a>
        ...
        <div class="col-md-2"></div>
            ...
            <li><a class="active" href="game-point-weekly-leader-board">This Week</a></li>
  ...
  <ul class="pagination">
    ...
    <?php
        // Number of Index show
         $score_games = getWeeklyPointLeaderBoardIndex();
         $index_counter = 0;
