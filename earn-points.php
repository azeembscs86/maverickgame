    ...
    <div class="col-md-1"></div>
      <div class="col-md-10">
        <div class="leader-wrap">
          ...
          <br/>
          <div class="row">
            <div class="col-md-4" align="center"> <img class="img-responsive" src="assets/images/play-game.png">
              <p class="white">Earn 5 points for every day that you play on Kabam.com.* <br/>
                You can even earn bonus points! </p>
            </div>
            <div class="col-md-4" align="center"> <img class="img-responsive" src="assets/images/login-bonus.png">
              <p class="white">Earn 50 bonus points for playing 7 days in a row! </p>
            </div>
            <div class="col-md-4" align="center"> <img class="img-responsive" src="assets/images/surprise-bonuses.png">
          ...
          <div class="currency-wrap"  align="center">
            <div class="row">
              <div class="col-md-12" align="center"> <img src="assets/images/game-currency.png" class="img-responsive">
          ...
          <div class="row" align="center">
            <div class="col-lg-12">
              ...
              <a href="javascript:;" class="button large game" style="float:none;">PLAY NOW</a> <br/>
              <br/>
            </div>
          </div>
        </div>
