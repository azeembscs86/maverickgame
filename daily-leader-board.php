...
<script>
   ...
   function score_pagination(nooflist,messagestatus)
   {
			...
			xhr.open('GET','daily_pagination.php?noofitemshow='+nooflist+'&message='+messagestatus,true);
			xhr.send();
...
<div class="container">
    ...
    <a href="game-point-leader-board">Point Leaderboard</a>
        ...
        <div class="col-md-2"></div>
            ...
            <li><a class="active" href="game-point-daily-leader-board">Today </a></li>
          </ul></div>
  ...
  <ul class="pagination">
    ...
    <?php
        // Number of Index show
         $score_games = getDailyPointsLeaderBoard();
         $index_counter = 0;
